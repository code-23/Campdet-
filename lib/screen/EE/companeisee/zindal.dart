...
class Zindal extends StatefulWidget {
  const Zindal({Key? key}) : super(key: key);

  @override
  _ZindalState createState() => _ZindalState();
}

class _ZindalState extends State<Zindal> {
  @override
